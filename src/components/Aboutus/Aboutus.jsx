    ...
    return (
        <div className='aboutUs'>
            <div className="a-left">
                ...
                initial={{opacity:0,x:-100}}
                whileInView={{opacity:1,x:0}}
                transition={{transition:transition,duration:1.5}}>Driving Innovation and Empowering Businesses.</motion.span>
                <motion.span className='aboutDesc'
                initial={{opacity:0,x:-100}}
                whileInView={{opacity:1,x:0}}
                transition={{transition:transition,duration:2}}
            ...
            initial={{opacity:0,x:100}}
            whileInView={{opacity:1,x:0}}
            transition={{transition,duration:1}}></motion.div>
