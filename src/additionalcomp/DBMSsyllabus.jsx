...
const DBMSsyllabus = () => {
    const { ddata } = useFetch('http://localhost:1337/api/database-syllabi?populate=deep')
    console.log('dbms',ddata)
                                ...
                                return (
                                    <>
                                        ...
                                        <div className="syllabusDesc">
                                            ...
                                            {
                                                (val.attributes.database_section_lists.data.map((val, key) => {
                                                    const description = val.attributes.database_section_content.data.attributes.Description
                                                    ...
                                                    return (
                                                        <>
                                                            <div className="syllabusContent" key={key}>
                                                                ...
                                                                <span>{val.attributes.database_section_content.data.attributes.Title}</span>
