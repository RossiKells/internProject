...
const Flutter = () => {
    const { ddata } = useFetch('http://localhost:1337/api/flutter-syllabi?populate=deep');
                                ...
                                return (
                                    <>
                                        ...
                                        <div className="syllabusDesc">
                                            ...
                                            {
                                                (val.attributes.flutter_section_lists.data.map((val, key) => {
                                                    const description = val.attributes.flutter_section_content.data.attributes.Description
                                                    ...
                                                    return (
                                                        <>
                                                            <div className="syllabusContent" key={key}>
                                                                ...
                                                                <span>{val.attributes.flutter_section_content.data.attributes.Title}</span>
